...
For benchmarks, import BENCHMARKS_BY_ID from satellite.services.evals.
"""
...
MODEL_BOXES = [
    {
        "id": "lab-apis",
        "name": "Lab APIs",
        "description": "OpenAI, Anthropic, Google, OpenRouter",
        "shortcut": "",
    },
    {
        "id": "cloud-apis",
    ...
    },
    {
        "id": "open-hosted",
        "name": "Open (Hosted)",
        "description": "Groq, Together, Fireworks, SambaNova",
        "shortcut": "",
    },
    {
        "id": "open-local",
...
PROVIDERS_BY_CATEGORY = {
    ...
    "cloud-apis": [
        ...
        },
        {
            "id": "azureai",
            "name": "Azure AI",
            "model_prefix": "azureai/",
            "env_var": "AZUREAI_API_KEY",
        },
        {
            "id": "vertex",
            "name": "Google Vertex",
    ...
    "open-hosted": [
        ...
        },
        {
            "id": "hf-inference",
            "name": "HF Inference",
            "model_prefix": "hf-inference-providers/",
            "env_var": "HF_TOKEN",
        },
    ],
    "open-local": [
...
MODEL_PROVIDERS = [
    provider for providers in PROVIDERS_BY_CATEGORY.values() for provider in providers
]
