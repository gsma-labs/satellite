...
This is the landing page users see when launching satellite.
...
from satellite.services.config import EnvConfigManager, EvalSettingsManager
from satellite.services.evals import EvalResult, Job, JobManager
from satellite.services.evals.job_manager import DEFAULT_JOBS_DIR
...
# Project root (4 levels up from screens/main.py: screens → satellite → src → root)
