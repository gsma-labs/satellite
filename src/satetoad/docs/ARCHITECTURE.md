# Satetoad Architecture

This document explains how satetoad is structured and how components interact.
...
Satetoad uses ONE screen only. This simplifies:
- Navigation logic
- State management
- Learning curve
